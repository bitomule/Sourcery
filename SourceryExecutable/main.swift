...
func runCLI() {
    command(
        ...
        VariadicOption<String>("force-parse", description: "File extensions or annotations that Sourcery will be forced to parse, even if they were generated by Sourcery."),
